...
public class Day02Main {
    public static void main(String[] args) throws FileNotFoundException {
        IntCodeProcessor intCodeProcessor = FileProcessor.processFileByPathWithStringProcessFunction("day02/src/main/resources/day02.txt", IntCodeProcessor::new).get(0);
